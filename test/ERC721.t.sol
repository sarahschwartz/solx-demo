...
contract MyTokenTest is Test {
    ...
    function test_721Interfaces() public view {
        assertTrue(token.supportsInterface(type(IERC721).interfaceId), "IERC721 not supported");
        assertTrue(token.supportsInterface(type(IERC721Enumerable).interfaceId), "IERC721Enumerable not supported");
    }
}
